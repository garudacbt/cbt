							...
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
										...
										<textarea id="header-1" class="form-control" name="header_1" rows="2" placeholder="Header baris 1" required><?=$kop->header_1?></textarea>
									</div>
								</div>
								<div class="col-md-6">
									<div class="form-group">
										<label>Header 2</label>
										<textarea id="header-2" class="form-control" name="header_2" rows="2" placeholder="Header baris 2" required><?=$kop->header_2?></textarea>
									</div>
								</div>
								<div class="col-md-6">
									<div class="form-group">
										<label>Header 3</label>
										<textarea id="header-3" class="form-control" name="header_3" rows="2" placeholder="Header baris 3" required><?=$kop->header_3?></textarea>
									</div>
								</div>
								<div class="col-md-6">
									<div class="form-group">
										<label>Header 4</label>
										<textarea id="header-4" class="form-control" name="header_4" rows="2" placeholder="Header baris 4" required><?=$kop->header_4?></textarea>
									</div>
								</div>
								<div class="col-md-6">
									<div class="form-group">
										<label>Kota/Kab</label>
										<input id="input-kota" class="form-control" name="kota" placeholder="Kota/Kab" value="<?=$kop->kota?>" required>
									</div>
								</div>
								<div class="col-md-6">
									<div class="form-group">
										<label>Titimangsa</label>
										<input id="input-tanggal" class="form-control" name="tanggal" placeholder="Titimangsa" value="<?=$kop->tanggal?>" required>
									</div>
								</div>
								<div class="col-md-6">
									<div class="form-group">
										<label>Kepala Sekolah</label>
										<input id="input-kepsek" class="form-control" name="kepala_sekolah" placeholder="Kepala Sekolah" value="<?=$kop->kepala_sekolah?>" required>
									</div>
								</div>
								<div class="col-md-6">
									<div class="form-group">
										<label>Proktor</label>
										<input id="input-proktor" class="form-control" name="proktor" placeholder="Proktor" value="<?=$kop->proktor?>" required>
									</div>
								</div>
								<div class="col-md-6">
									<div class="form-group">
										<label>Pengawas 1</label>
										<input id="input-pengawas-1" class="form-control" name="pengawas_1" placeholder="Pengawas 1" value="<?=$kop->pengawas_1?>" required>
									</div>
								</div>
								<div class="col-md-6">
									<div class="form-group">
										<label>Pengawas 2</label>
										<input id="input-pengawas-2" class="form-control" name="pengawas_2" placeholder="Pengawas 2" value="<?=$kop->pengawas_2?>" required>
									</div>
								</div>
							</div>
							<?= form_close() ?>
