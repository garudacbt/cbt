    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                ...
                <div class="col-6">
                    <a href="<?= base_url('walisiswa') ?>" type="button" class="btn btn-sm btn-danger float-right">
    ...
    <section class="content">
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    <?= form_open('walisiswa/updatedata', array('id' => 'siswa'), array('method' => 'edit', 'id_siswa' => $siswa->id_siswa)) ?>
                        ...
                        <div class="card-body">
                            <div class="tab-content">
                                <div class="tab-pane active" id="datasiswa">
                                    ...
                                    <div class="mt-5"><i>Semua isian di segment ini harus diisi</i></div clas>
                                </div>
                                    ...
                                    <?php foreach ($input_bio as $bio) : ?>
                                        ...
                                        <?php elseif ($bio->name == 'status_keluarga'): ?>
                                            <div class="form-group row">
                                                <div class="col-md-4 mb-sm-0">
                                                    <label for="<?= $bio->name ?>"
                                                           class="align-middle"><?= $bio->label ?></label>
                                                </div>
                                                <div class="col-md-8 mb-sm-0">
                                                    <div class="input-group">
                                                        <?php
