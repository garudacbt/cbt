			...
			<div class="card card-default my-shadow mb-4">
				<div class="card-header">
					...
					<div class="card-tools">
						...
						<button type="button" data-toggle="modal" data-target="#createSesiModal" class="btn btn-sm btn-primary"><i
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<div class="form-group row">
					...
					<div class="col-md-8">
						<input type="text" id="jamAwal" name="waktu_mulai" class="form-control" autocomplete="off" required>
					</div>
				</div>
				<div class="form-group row">
					<label class="col-md-4 col-form-label">Jam Berakhir*</label>
					<div class="col-md-8">
						<input type="text" id="jamAkhir" name="waktu_akhir" class="form-control" autocomplete="off" required>
					</div>
				</div>
			</div>
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<div class="form-group row">
					<label class="col-md-4 col-form-label">Jam Mulai*</label>
					<div class="col-md-8">
						<input type="text" id="jamAwalEdit" name="waktu_mulai" class="form-control" autocomplete="off" required>
					</div>
				</div>
				<div class="form-group row">
					<label class="col-md-4 col-form-label">Jam Berakhir*</label>
					<div class="col-md-8">
						<input type="text" id="jamAkhirEdit" name="waktu_akhir" class="form-control" autocomplete="off" required>
					</div>
				</div>
			</div>
			<div class="modal-footer">
