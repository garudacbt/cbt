			...
			<div class="card card-default my-shadow mb-4">
				<div class="card-header">
					...
					<div class="card-tools">
						...
						<button type="button" data-from="add" data-toggle="modal" data-target="#createTahunModal" class="btn btn-sm bg-gradient-primary"><i
					...
					<div class="row">
								...
								<?php foreach ($tp as $key => $value) : ?>
									<tr>
										...
										<td class="text-center">
											...
											<?php else :?>
												<button type="button" data-id="<?=$value->id_tp?>" class="btn btn-xs btn-primary btn-aktif">AKTIFKAN</button>
											<?php endif;?>
										</td>
										<td class="text-center">
						...
						<div class="col-md-5">
									...
									<tr>
										...
										<td class="text-center">
											<?php if ($value->active) :?>
												<span class="text-success"><i class="fa fa-check mr-2"></i>AKTIF</span>
											<?php else :?>
												<button type="button" data-id="<?=$value->id_smt?>" class="btn btn-xs btn-primary btn-aktif">AKTIFKAN</button>
											<?php endif;?>
										</td>
									</tr>
								<?php endforeach; ?>
                            ...
                            <div class="input-group">
                                <input name="jml_hari" value="<?=$jml_hari?>" type="number" class="form-control" required>
...
<div class="modal fade" id="createTahunModal" tabindex="-1" role="dialog" aria-labelledby="editModalLabel" aria-hidden="true">
