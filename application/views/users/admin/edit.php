				...
				<div class="col-md-6">
							...
							<div class="row">
								...
								<div class="col-7">
									<div class="form-group">
										...
										<input type="text" placeholder="Nama Lengkap" id="nama-lengkap" class="form-control" value="<?=$profile->nama_lengkap?>">
									</div>
									<div class="form-group">
										<label>Jabatan</label>
										<input type="text" id="jabatan"  placeholder="Jabatan" class="form-control" value="<?=$profile->jabatan?>">
									</div>
									<button onclick="simpanProfile()" id="simpan" class="btn btn-success float-right mt-3">Simpan
									</button>
								</div>
							</div>
						</div>
					...
					<div class="col-md-6">
						...
						<div class="card card-warning my-shadow">
							...
							<div class="card-footer">
								<button type="submit" id="btn-pass" class="btn btn-warning float-right ml-3">Ganti Password
								</button>
