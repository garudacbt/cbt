				...
				<div class="card-body">
					...
					<div id="input-tugas" class="row">
						<div class="col-md-3 mb-3">
							<label>Kode</label>
							<input name="kode_tugas" value="<?=$tugas->kode_tugas?>" type="text" class="form-control form-control-sm" required>
						</div>
						<div class="col-md-3 mb-3">
							<label>Guru</label>
						...
						<div class='col-md-3 mb-3'>
							<label>Mapel</label>
							<select name="mapel" id="mapel" class="select2 form-control form-control-sm w-100" required=""></select>
						</div>
						<div class='col-md-3 mb-3'>
							<label>Kelas</label>
							<select name="kelas[]" id="kelas" class="select2 form-control form-control-sm" multiple="multiple"
