			...
			<div class="card card-default my-shadow mb-4">
				...
				<div class="card-header">
					...
					<div class="card-tools">
						...
						<button type="button" data-toggle="modal" data-target="#createSiswaModal" class="btn btn-sm btn-primary"><i
								class="fas fa-plus"></i><span class="d-none d-sm-inline-block ml-1">Tambah Siswa</span>
						</button>
                        ...
                        <a href="<?= base_url('datasiswa/update') ?>" class="btn btn-sm bg-gradient-success"><i
                                    class="fas fa-database"></i><span class="d-none d-sm-inline-block ml-1">Update Data</span></a>
					</div>
				</div>
				<div class="card-body">
                    <?php
				...
				<div class="row mb-3">
					...
					<div class="col-md-8 col-sm-offset-8">
						<div class="input-group">
							...
							<input id="nama_siswa" type="text" class="form-control" name="nama_siswa" placeholder="Nama Siswa" required>
						</div>
					</div>
				</div>
				<div class="row mb-3">
				...
				<div class="row mb-3">
                    ...
                    <div class="col-md-8 col-sm-offset-8">
                        <div class="input-group">
                            ...
                            <select class="form-control" id="kelas_awal" data-placeholder="Jenis Kelamin" name="jenis_kelamin">
				...
				<div class="row mb-3">
					...
					<div class="col-md-8 col-sm-offset-8">
						<div class="input-group">
							...
							?>
							<select class="form-control" id="kelas_awal" data-placeholder="Pilih Kelas" name="kelas_awal">
				...
				<div class="row mb-3">
					...
					<div class="col-md-8 col-sm-offset-8">
						<div class="input-group">
							...
							<input type="text" name="tahun_masuk" id="tahunmasuk" class="form-control" autocomplete="off" placeholder="Tgl/Tahun Masuk" required>
						</div>
					</div>
				</div>
				<div class="row mb-3">
