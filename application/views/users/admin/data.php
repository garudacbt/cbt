			...
			<div class="card card-default my-shadow">
				<div class="card-header with-border">
					...
					<div class="card-tools">
						...
						<button type="button" data-toggle="modal" data-target="#createAdminModal" class="btn btn-sm btn-primary"><i
								class="fas fa-plus"></i><span class="d-none d-sm-inline-block ml-1">Tambah Admin</span>
						</button>
					</div>
				</div>
				<div class="card-body">
...
<div class="modal fade" id="createAdminModal" tabindex="-1" role="dialog" aria-labelledby="editModalLabel" aria-hidden="true">
