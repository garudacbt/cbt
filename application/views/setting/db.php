					...
					<table id="database" class="table table-striped table-bordered table-hover table-sm">
						...
						foreach ($list as $key => $value) :?>
							<tr>
								...
								<td class="text-center">
									<a href="<?=base_url('./backups/' . $value['src'])?>" download="<?=$value['src']?>" type="button" class="btn btn-xs btn-warning btn-download">Download</a>
									<button onclick="hapus('<?=$value['src']?>')" type="button" class="btn btn-xs btn-danger btn-hapus">Hapus</button>
								</td>
							</tr>
						<?php endforeach; ?>
						</tbody>
