		...
		<nav class="mt-2 mb-5">
			<ul class="nav nav-pills nav-sidebar flex-column nav-child-indent" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <li class="nav-item has-treeview <?= in_array($page, $wali)  ? "menu-open" : ""  ?>">
					...
					<ul class="nav nav-treeview">
						<li class="nav-item">
							<a href="<?=base_url('walisiswa')?>" class="nav-link <?=$page==='walisiswa'?"active":""?>">
								<i class="far fa-circle nav-icon"></i>
								<p>Siswa</p>
							</a>
						</li>
						<li class="nav-item">
                            <a href="<?=base_url('walistruktur')?>" class="nav-link <?=$page==='walistruktur'?"active":""?>">
								<i class="far fa-circle nav-icon"></i>
								<p>Struktur</p>
							</a>
						</li>
						<li class="nav-item">
                            <a href="<?=base_url('walicatatan')?>" class="nav-link <?=$page==='walicatatan'?"active":""?>">
								<i class="far fa-circle nav-icon"></i>
								<p>Catatan Kelas</p>
							</a>
						</li>
                ...
                <li class="nav-item has-treeview <?= in_array($pageact, $data_rapor)  ? "menu-open" : ""  ?>">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="<?=base_url('rapor/raporkkm')?>" class="nav-link <?=$pageact==='raporkkm'?"active":""?>">
                                <i class="far fa-circle nav-icon"></i>
                                <p>KKM dan Bobot</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="<?=base_url('rapor/raporkikd')?>" class="nav-link <?=$pageact==='raporkikd'?"active":""?>">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Indikator Nilai</p>
                            </a>
                        </li>
                ...
                <li class="nav-item">
                    <a href="<?=base_url('rapor/rapornilai')?>" class="nav-link <?=$pageact==='rapornilai'?"active":""?>">
                        <i class="far fa-circle nav-icon"></i>
                        <p>INPUT NILAI</p>
                    </a>
                </li>
                ...
                <li class="nav-item has-treeview <?= in_array($pageact, $rapor_input)  ? "menu-open" : ""  ?>">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="<?=base_url('rapor/raporspiritual')?>" class="nav-link <?=$pageact==='raporspiritual'?"active":""?>">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Sikap Spiritual</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="<?=base_url('rapor/raporsosial')?>" class="nav-link <?=$pageact==='raporsosial'?"active":""?>">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Sikap Sosial</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="<?=base_url('rapor/raporprestasi')?>" class="nav-link <?=$pageact==='raporprestasi'?"active":""?>">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Prestasi</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="<?=base_url('rapor/raporcatatan')?>" class="nav-link <?=$pageact==='raporcatatan'?"active":""?>">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Absensi & Catatan</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="<?=base_url('rapor/raporfisik')?>" class="nav-link <?=$pageact==='raporfisik'?"active":""?>">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Fisik</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="<?=base_url('rapor/rapornaik')?>" class="nav-link <?=$pageact==='rapornaik'?"active":""?>">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Kenaikan</p>
                            </a>
                        </li>
                ...
                <li class="nav-item has-treeview <?= in_array($pageact, $rapor_cetak)  ? "menu-open" : ""  ?>">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="<?=base_url('rapor/cetakpts')?>" class="nav-link <?=$pageact==='cetakpts'?"active":""?>">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Rapor PTS</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="<?=base_url('rapor/cetakakhir')?>" class="nav-link <?=$pageact==='cetakakhir'?"active":""?>">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Rapor Akhir</p>
                            </a>
                        </li>
