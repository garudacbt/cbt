                    ...
                    if (count($tgl_jadwals) > 0) : ?>
                        <table class="table table-bordered" id="tbl-pengawas">
                            ...
                            foreach ($tgl_jadwals as $tgl => $jadwal):
                                ...
                                <tr>
                                    <td class="text-center align-middle jadwal"
                                        data-id="<?= implode(',', $listIdJad) ?>"><?= $listMapel[$i] ?></td>
                                    <!--
                                    <?php
                                    /*
                                    $listKelas = $jadwal[$listMapel[0]];
                            ...
                            foreach ($jadwals as $jadwal):
                                if (isset($ruang_sesi[$sesi_selected]) && isset($ruang_sesi[$sesi_selected][$ruang_selected])) :
                                    ...
                                    if ($kkl != '') :
                                        ...
                                        <tr>
                                            <td class="text-center align-middle jadwal"
                                                data-id="<?= $jadwal->id_jadwal ?>"><?= $no ?></td>
