            ...
            <div id="demo" class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img src="<?=base_url("/assets/img/ma1.jpg")?>" alt="Los Angeles" style="width: 100%; height: auto; object-fit: cover;object-position: center;">
                    </div>
                    <div class="carousel-item">
                        <img src="<?=base_url("/assets/img/ma2.jpg")?>" alt="Chicago" style="width: 100%; height: auto; object-fit: cover;object-position: center;">
                    </div>
                    <div class="carousel-item">
                        <img src="<?=base_url("/assets/img/ma3.jpg")?>" alt="New York" style="width: 100%; height: auto; object-fit: cover;object-position: center;">
                    </div>
                </div>
