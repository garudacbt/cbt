							...
							<div class="row mb-3">
								...
								<div class="col-md-8 col-sm-offset-8">
									<div class="input-group">
										...
										<input id="nama_guru" type="text" class="form-control" name="nama_guru" placeholder="Nama Guru" required>
									</div>
								</div>
							</div>
							<div class="row">
				...
				<div class="col-xl-4 col-lg-5">
					<div class="card my-shadow mb-4">
						...
						<div class="card-header">
							...
							<a href="<?= base_url('uploads/import/format/format_guru.xlsx') ?>" class="card-tools btn-success btn btn-sm">
					...
					<div class="card my-shadow mb-4">
						...
						<div class="card-header">
							...
							<a href="<?= base_url('uploads/import/format/format_guru.docx') ?>" class="btn-success btn btn-sm card-tools">
								<i class="fas fa-download"></i><span class="ml-2">Download Template</span>
							</a>
						</div>
