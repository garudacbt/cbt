										...
										<div class="col-md-6 col-lg-4">
											<div class="card border">
												...
												<?php if (in_array($jamke, $arrIst)) :
													...
													if (isset($tugas[$jamke]->nama_mapel)) :
														$tkelas = '';
														...
														<div class="card-body p-0">
															<div class="small-box bg-gradient-danger mb-0">
																<div class="inner">
																	...
																	<span><?= $tugas[$jamke]->nama_mapel ?></span>
																	<br>
...
<script>
    ...
    function getMateri(tgl) {
        ...
        setTimeout(function() {
            $.ajax({
                url: base_url + 'siswa/seminggu?id_siswa='+idSiswa+'&id_kelas='+idKelas+'&tgl='+tgl+'&jenis=2',
                type:"GET",
                        ...
                        if (mtr.id_kjm != null) {
                            ...
                            if (data.logs != null && Object.keys(data.logs).length > 0) {
                                if (data.logs[mtr.id_kjm][2] == null) {
                                    status = '<a href="'+base_url+'siswa/bukatugas/'+ mtr.id_kjm + '/' +i+'" class="btn btn-warning">Belum Selesai</a>';
                                } else {
                                    status = '<a href="'+base_url+'siswa/bukatugas/'+ mtr.id_kjm + '/' +i+'" class="btn btn-success">Selesai</a>';
                                }
                            } else {
                                status = '<a href="'+base_url+'siswa/bukatugas/'+ mtr.id_kjm + '/' +i+'" class="btn btn-danger">Belum Dikerjakan</a>';
                            }
