			...
			<div class="card card-default my-shadow mb-4">
				<div class="card-header">
					...
					<div class="card-tools">
                        ...
                        <button type="button" data-toggle="modal" data-target="#openAllMateri" class="btn btn-sm btn-success"><i class="fa fa-copy"></i> Copy Materi</button>
					</div>
				</div>
				<div class="card-body">
                    <div class="alert alert-default-info align-content-center" role="alert">
                            Untuk mengcopy materi dari tahun atau semester sebelumnya <b>ke TP <?=$tp_active->tahun?> SMT <?=$smt_active->nama_smt?></b>,
                            <ul>
                                <li>
                                    Pilih Nama Guru
                                </li>
...
<div class="modal fade" id="openAllMateri" tabindex="-1" role="dialog" aria-labelledby="openMateriLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
