                ...
                <div class="card-header">
                    <div class="btn-group mb-1">
                        ...
                        <a href="<?= base_url('bukurapor/editnilairapor?id_siswa=' . $id_siswa . '&mode=2') ?>"
                           type="button"
                           class="btn btn-sm btn-outline-primary<?= $active2 ?>"><i class="fa fa-pencil"></i> Pengetahuan</a>
                        <a href="<?= base_url('bukurapor/editnilairapor?id_siswa=' . $id_siswa . '&mode=3') ?>"
                           type="button"
                           class="btn btn-sm btn-outline-primary<?= $active3 ?>"><i class="fa fa-pencil"></i> Keterampilan</a>
                        ...
                        <div style="display: flex;-webkit-justify-content: center;justify-content: center;margin-top: 4px;">
                            ...
                            <table style="width: 100%; border: 2px solid black; border-collapse: collapse">
                                ...
                                <tr style="font-family: 'Tahoma';">
                                    <td class="editable" style="width: 30%;height:200px;border: 1px solid black; border-collapse: collapse;text-align: center">
                                        <b><?=$pred_a?></b></td>
                                    <td class="editable" style="width:70%;border: 1px solid black; border-collapse: collapse;padding: 6px"><?=$desk_a?></td>
                                </tr>
                                </tbody>
                            </table>
                        </div>
                        ...
                        <div style="display: flex;-webkit-justify-content: center;justify-content: center;margin-top: 4px;">
                            <table style="width: 100%; border: 2px solid black; border-collapse: collapse">
                                ...
                                <tr style="font-family: 'Tahoma';">
                                    <td class="editable" style="width: 30%;height:200px;border: 1px solid black; border-collapse: collapse;text-align: center">
                                        <b><?=$pred_b?></b></td>
                                    <td class="editable" style="width:70%;border: 1px solid black; border-collapse: collapse;padding: 6px;vertical-align: center"><?=$desk_b?></td>
                                </tr>
                                </tbody>
                            </table>
                        </div>
                    ...
                    <div id="nilai2">
                        ...
                        <table style="width: 100%;border: 2px solid black; border-collapse: collapse;margin-top: 6px">
                            ...
                            <tr style="font-family: 'Tahoma';text-align: center;background: #E6E7E9">
                                <td rowspan="2" style="width:5%;border: 1px solid black; border-collapse: collapse"><b>NO</b>
                                </td>
                                <td rowspan="2" style="width:20%;border: 1px solid black; border-collapse: collapse"><b>Mata
                                        Pelajaran</b></td>
                                <td rowspan="2"
                                    style="width:7%;border: 1px solid black; border-collapse: collapse;display:none;">
                                    <b>KKM</b></td>
                                <td colspan="3" style="height:25px;border: 1px solid black; border-collapse: collapse">
                                    <b>Pengetahuan</b></td>
                            </tr>
                            <tr style="font-family: 'Tahoma';text-align: center;background: #E6E7E9">
                                <td style="width:7%;height:25px;border: 1px solid black; border-collapse: collapse"><b>Nilai</b>
                                </td>
                                <td style="width:9%;border: 1px solid black; border-collapse: collapse"><b>Predikat</b>
                                </td>
                            ...
                            <tr style="font-family: 'Tahoma';">
                                <td style="border: 1px solid black; border-collapse: collapse; text-align: center;">2
                                </td>
                                <td style="border: 1px solid black; border-collapse: collapse; padding: 2px 4px 2px 4px">
                            ...
                            <tr style="font-family: 'Tahoma';">
                                <td style="border: 1px solid black; border-collapse: collapse; text-align: center;">3
                                </td>
                                <td style="border: 1px solid black; border-collapse: collapse; padding: 2px 4px 2px 4px">
                                    Bahasa Arab
                                </td>
                            ...
                            <tr style="font-family: 'Tahoma';">
                                <td style="border: 1px solid black; border-collapse: collapse; text-align: center;">4
                                </td>
                                <td style="border: 1px solid black; border-collapse: collapse; padding: 2px 4px 2px 4px">
                                    Bahasa Indonesia
                                </td>
                            ...
                            <tr style="font-family: 'Tahoma';">
                                <td style="border: 1px solid black; border-collapse: collapse; text-align: center;">5
                                </td>
                                <td style="border: 1px solid black; border-collapse: collapse; padding: 2px 4px 2px 4px">
                                    Matematika
                                </td>
                            ...
                            <tr style="font-family: 'Tahoma';">
                                <td style="border: 1px solid black; border-collapse: collapse; text-align: center;">6
                                </td>
                                <td style="border: 1px solid black; border-collapse: collapse; padding: 2px 4px 2px 4px">
                            ...
                            <tr style="font-family: 'Tahoma';">
                                <td style="border: 1px solid black; border-collapse: collapse; text-align: center;">7
                                </td>
                                <td style="border: 1px solid black; border-collapse: collapse; padding: 2px 4px 2px 4px">
                            ...
                            <tr style="font-family: 'Tahoma';">
                                <td style="border: 1px solid black; border-collapse: collapse; text-align: center;">8
                                </td>
                                <td style="border: 1px solid black; border-collapse: collapse; padding: 2px 4px 2px 4px">
                                    Bahasa Inggris
                                </td>
                            ...
                            <tr style="font-family: 'Tahoma';">
                                <td style="border: 1px solid black; border-collapse: collapse; text-align: center;">1
                                </td>
                                <td style="border: 1px solid black; border-collapse: collapse; padding: 2px 4px 2px 4px">
                                    Seni Budaya
                                </td>
                            ...
                            <tr style="font-family: 'Tahoma';">
                                <td style="border: 1px solid black; border-collapse: collapse; text-align: center;">9
                                </td>
                                <td style="border: 1px solid black; border-collapse: collapse; padding: 2px 4px 2px 4px">
                                    TEMA 9
                                </td>
                    ...
                    <div id="nilai3">
                        ...
                        <table style="width: 100%;border: 2px solid black; border-collapse: collapse;margin-top: 6px">
                            ...
                            <tr style="font-family: 'Tahoma';text-align: center;background: #E6E7E9">
                                ...
                                <td rowspan="2" style="width:25%;border: 1px solid black; border-collapse: collapse"><b>Mata
                                        Pelajaran</b></td>
                                <td rowspan="2"
                                    style="width:7%;border: 1px solid black; border-collapse: collapse;display:none;">
                                    <b>KKM</b></td>
                    ...
                    <div id="nilai4">
                        ...
                        <table style="width: 100%;border: 2px solid black; border-collapse: collapse;margin-top: 6px">
                            ...
                            <tr style="font-family: 'Tahoma';text-align: center;background: #E6E7E9">
                                ...
                                <td style="width:15%;height:35px;border: 1px solid black; border-collapse: collapse"><b>Nilai</b>
                                </td>
                            ...
                            <tr style="font-family: 'Tahoma';">
                                ...
                                <td style="border: 1px solid black; border-collapse: collapse; padding-left: 4px">Baca
                                    Tulis Al Quran
                                </td>
                                <td style="border: 1px solid black; border-collapse: collapse; text-align: center;"></td>
                            ...
                            <tr style="font-family: 'Tahoma';">
                                ...
                                <td style="border: 1px solid black; border-collapse: collapse; padding-left: 4px">Shalat
                                    Dhuha
                                </td>
                                <td style="border: 1px solid black; border-collapse: collapse; text-align: center;"></td>
                                <td style="border: 1px solid black; border-collapse: collapse; padding-left: 4px"></td>
                        ...
                        <table style="width: 100%;border: 2px solid black; border-collapse: collapse;margin-top: 6px">
                            <tbody>
                            <tr style="font-family: 'Tahoma';text-align: center;background: #E6E7E9">
                                <td style="width:5%;height:35px;border: 1px solid black; border-collapse: collapse"><b>NO</b>
                                </td>
                        ...
                        <div style="display: flex">
                            ...
                            <table style="width: 40%;border: 1px solid black; border-collapse: collapse;margin-top: 6px">
                                ...
                                <tr style="font-family: 'Tahoma';text-align: center;background: #E6E7E9">
                                    <td style="width:30%;border: 1px solid black; border-collapse: collapse"><b>1</b>
                                    </td>
                                    <td style="width:30%;border: 1px solid black; border-collapse: collapse"><b>2</b>
                                    </td>
                                </tr>
                                <tr></tr>
                                <tr style="font-family: 'Tahoma';">
                        ...
                        <table style="width: 50%;border: 1px solid black; border-collapse: collapse;margin-top: 6px">
                            ...
                            <tr style="font-family: 'Tahoma';">
                                <td style="border: 1px solid black; border-collapse: collapse;padding-left: 6px">Izin
                                </td>
                                <td style="border: 1px solid black; border-collapse: collapse;padding-left: 6px"> -
                                    hari
                                </td>
                            ...
                            <tr style="font-family: 'Tahoma';">
                                <td style="border: 1px solid black; border-collapse: collapse;padding-left: 6px">Tanpa
                                    Keterangan
                                </td>
                                <td style="border: 1px solid black; border-collapse: collapse;padding-left: 6px"> -
                                    hari
