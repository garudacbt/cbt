			...
			<div class="card card-default my-shadow mb-4">
				<div class="card-header">
					...
					<div class="card-tools">
						...
						<button type="button" data-toggle="modal" data-target="#createRuangModal" class="btn btn-sm btn-primary"><i
				...
				<div class="card-body">
					...
					<div class="table-responsive">
						<table id="ruang" class="w-100 table table-striped table-bordered table-hover table-sm">
							<thead>
							<tr>
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<div class="form-group row">
					...
					<div class="col-md-8">
						<input type="text" class="form-control" name="kode_ruang" placeholder="Kode Ruang Ujian" required>
					</div>
				</div>
