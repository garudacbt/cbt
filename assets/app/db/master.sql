...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 20 Apr 2021 pada 15.21
...
--
-- Struktur dari tabel `cbt_alokasi`
--
...
(123456, 'MADRASAH TSANAWIYAH AL HASAN', 'DAFTAR KEHADIRAN', 'UJIAN AKHIR MADRASAH (UAMBK)', 'TP: 2020/2021', 'Abdullah Al Hasan', 'Abdullah Al Hasan', 'p');
...
INSERT INTO `cbt_kop_berita` (`id_kop`, `header_1`, `header_2`, `header_3`, `header_4`) VALUES
(123456, 'MADRASAH TSANAWIYAH AL HASAN', 'BERITA ACARA PELAKSANAAN', 'TRY OUT U M B K', 'Tahun Pelajaran: 2020/2021 Semester: I');
...
(123456, 'MADRASAH TSANAWIYAH', 'KARTU PESERTA', 'UJIAN AKHIR MADRASAH (UMBK)', 'TAHUN PELAJARAN: 2020/2021', '29 Maret 2021');
...
(1, 'Sesi 1', 'S1', '08:00:00', '10:30:00', 1),
...
INSERT INTO `cbt_token` (`token`, `auto`) VALUES
('BDEFLU', 0);
...
--
-- Dumping data untuk tabel `master_hari_efektif`
--

INSERT INTO `master_hari_efektif` (`id_hari_efektif`, `jml_hari_efektif`) VALUES
(11, 97),
(12, 200);
...
INSERT INTO `master_mapel` (`id_mapel`, `nama_mapel`, `kode`, `kelompok`, `bobot_p`, `bobot_k`, `jenjang`, `urutan`, `status`, `deletable`) VALUES
(1, 'Al Quran-Hadis', 'QH', 'A', 0, 0, 1, 1, 1, 0),
(2, 'Fiqih', 'FQH', 'A', 0, 0, 1, 1, 1, 0),
(3, 'Akidah Akhlak', 'AA', 'A', 0, 0, 1, 1, 1, 0),
(4, 'Sejarah Kebudayaan Islam', 'SKI', 'A', 0, 0, 1, 1, 1, 0),
(5, 'Bahasa Arab', 'BAR', 'A', 0, 0, 1, 2, 1, 0),
(6, 'Bahasa Indonesia', 'BIND', 'A', 0, 0, 1, 2, 1, 0),
(7, 'Bahasa Inggris', 'BING', 'A', 0, 0, 1, 2, 1, 0),
(8, 'Matematika', 'MTK', 'A', 0, 0, 1, 2, 1, 0),
(9, 'Ilmu Pengetahuan Alam', 'IPA', 'A', 0, 0, 1, 2, 1, 0),
(10, 'Ilmu Pengetahuan Sosial', 'IPS', 'A', 0, 0, 1, 2, 1, 0),
(11, 'Pendidikan Pancasila dan Kewarganegaraan', 'PPKn', 'A', 0, 0, 1, 2, 1, 0),
(12, 'Pendidikan Jasmani Olah Raga dan Kesehatan', 'PJOK', 'B', 0, 0, 1, 3, 1, 0),
(13, 'Seni Budaya', 'SB', 'B', 0, 0, 2, 3, 1, 0),
(14, 'Prakarya', 'PRA', 'B', 0, 0, 2, 3, 1, 0),
(15, 'SBdP', 'SBDP', 'B', 0, 0, 0, 3, 1, 0),
(16, 'Akhlak', 'AK', 'C', 0, 0, 3, 0, 1, 0),
(17, 'Antropologi', 'ANT', 'C', 0, 0, 3, 0, 1, 0),
(18, 'Bahasa Arab', 'BAR', 'C', 0, 0, 3, 0, 1, 0),
(19, 'Bahasa dan Sastra Asing Lainnya', 'BSAL', 'C', 0, 0, 3, 0, 1, 0),
(20, 'Bahasa dan Sastra Indonesia', 'BSIN', 'C', 0, 0, 3, 0, 1, 0),
(21, 'Bahasa dan Sastra Inggris', 'BSING', 'C', 0, 0, 3, 0, 1, 0),
(22, 'Bahasa Jepang', 'JPN', 'C', 0, 0, 3, 0, 1, 0),
(23, 'Bahasa Jerman', 'JRM', 'C', 0, 0, 3, 0, 1, 0),
(24, 'Biologi', 'BIO', 'C', 0, 0, 3, 0, 1, 0),
(25, 'Ekonomi', 'EKN', 'C', 0, 0, 3, 0, 1, 0),
(26, 'Fikih', 'FQH', 'C', 0, 0, 3, 0, 1, 0),
(27, 'Fikih - Ushul Fikih', 'UFQH', 'C', 0, 0, 3, 0, 1, 0),
(28, 'Fisika', 'FIS', 'C', 0, 0, 3, 0, 1, 0),
(29, 'Geografi', 'GEO', 'C', 0, 0, 3, 0, 1, 0),
(30, 'Hadis - Ilmu Hadis', 'HA', 'C', 0, 0, 3, 0, 1, 0),
(31, 'Ilmu Kalam', 'IK', 'C', 0, 0, 3, 0, 1, 0),
(32, 'Informatika', 'INF', 'C', 0, 0, 3, 0, 1, 0),
(33, 'Keterampilan', 'KTR', 'C', 0, 0, 3, 0, 1, 0),
(34, 'Kimia', 'KIM', 'C', 0, 0, 3, 0, 1, 0),
(35, 'Prakarya dan Kewirausahaan', 'PK', 'B', 0, 0, 3, 0, 1, 0),
(36, 'Sejarah', 'SEJ', 'C', 0, 0, 3, 0, 1, 0),
(37, 'Sejarah Indonesia', 'SJI', 'A', 0, 0, 3, 0, 1, 0),
(38, 'Sosiologi', 'SOS', 'C', 0, 0, 3, 0, 1, 0),
(39, 'Tafsir - Ilmu Tafsir', 'TT', 'C', 0, 0, 3, 0, 1, 0),
(40, 'Bahasa Sunda', 'BSUND', 'MULOK', 0, 0, 1, 0, 1, 1);
...
(12, 1, 2, 1, 70, 40, 20, 40, NULL, '19 Jan 2021', '08 Apr 2021');
...
(1, 'Selamat melaksanakan Try Out UMBK tingkat MTs'),
(2, 'test 2'),
(3, 'test3'),
(4, 'test 56'),
(5, '');
...
--
-- Indeks untuk tabel `cbt_alokasi`
--
ALTER TABLE `cbt_alokasi`
...
--
-- AUTO_INCREMENT untuk tabel `cbt_alokasi`
--
ALTER TABLE `cbt_alokasi`
...
--
ALTER TABLE `cbt_bank_soal`
  MODIFY `id_bank` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=109;
...
--
ALTER TABLE `cbt_pengawas`
  MODIFY `id_pengawas` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=99;
...
--
ALTER TABLE `cbt_sesi_siswa`
  MODIFY `siswa_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=792;

--
-- AUTO_INCREMENT untuk tabel `cbt_soal`
--
ALTER TABLE `cbt_soal`
  MODIFY `id_soal` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2919;
...
--
ALTER TABLE `kelas_catatan_mapel`
  MODIFY `id_catatan` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=29;
...
--
ALTER TABLE `kelas_materi`
  MODIFY `id_materi` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=568;

--
-- AUTO_INCREMENT untuk tabel `kelas_struktur`
--
ALTER TABLE `kelas_struktur`
  MODIFY `id_kelas` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=59;

--
-- AUTO_INCREMENT untuk tabel `kelas_tugas`
--
ALTER TABLE `kelas_tugas`
  MODIFY `id_tugas` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=273;
...
--
ALTER TABLE `log`
  MODIFY `id_log` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2107;
...
--
ALTER TABLE `log_ujian`
  MODIFY `id_log` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=300293;
...
--
ALTER TABLE `master_guru`
  MODIFY `id_guru` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=290;

--
-- AUTO_INCREMENT untuk tabel `master_hari_efektif`
--
ALTER TABLE `master_hari_efektif`
  MODIFY `id_hari_efektif` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
...
--
ALTER TABLE `master_kelas`
  MODIFY `id_kelas` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=78;
...
--
ALTER TABLE `master_tp`
  MODIFY `id_tp` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;
...
--
ALTER TABLE `rapor_catatan_wali`
  MODIFY `id_catatan_wali` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5218112;

--
-- AUTO_INCREMENT untuk tabel `rapor_data_catatan`
--
ALTER TABLE `rapor_data_catatan`
  MODIFY `id_catatan` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=52327;

--
-- AUTO_INCREMENT untuk tabel `rapor_data_fisik`
--
ALTER TABLE `rapor_data_fisik`
  MODIFY `id_fisik` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=25;

--
-- AUTO_INCREMENT untuk tabel `rapor_data_sikap`
--
ALTER TABLE `rapor_data_sikap`
  MODIFY `id_sikap` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=52211;

--
-- AUTO_INCREMENT untuk tabel `rapor_fisik`
--
ALTER TABLE `rapor_fisik`
  MODIFY `id_fisik` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5218112;

--
-- AUTO_INCREMENT untuk tabel `rapor_kikd`
--
ALTER TABLE `rapor_kikd`
  MODIFY `id_kikd` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=105229;

--
-- AUTO_INCREMENT untuk tabel `rapor_kkm`
--
ALTER TABLE `rapor_kkm`
  MODIFY `id_kkm` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6702;

--
-- AUTO_INCREMENT untuk tabel `rapor_nilai_akhir`
--
ALTER TABLE `rapor_nilai_akhir`
  MODIFY `id_nilai_akhir` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=105218112;

--
-- AUTO_INCREMENT untuk tabel `rapor_nilai_ekstra`
--
ALTER TABLE `rapor_nilai_ekstra`
  MODIFY `id_nilai_ekstra` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=57016613;

--
-- AUTO_INCREMENT untuk tabel `rapor_nilai_harian`
--
ALTER TABLE `rapor_nilai_harian`
  MODIFY `id_nilai_harian` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=105218112;

--
-- AUTO_INCREMENT untuk tabel `rapor_nilai_pts`
--
ALTER TABLE `rapor_nilai_pts`
  MODIFY `id_nilai_pts` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=105218112;

--
-- AUTO_INCREMENT untuk tabel `rapor_nilai_sikap`
--
ALTER TABLE `rapor_nilai_sikap`
  MODIFY `id_nilai_sikap` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=107225112;

--
-- AUTO_INCREMENT untuk tabel `rapor_prestasi`
--
ALTER TABLE `rapor_prestasi`
  MODIFY `id_ranking` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5218112;
...
--
ALTER TABLE `users`
  MODIFY `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2471;
