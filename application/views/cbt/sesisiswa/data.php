			...
			<div class="card card-default my-shadow mb-4">
				<div class="card-header">
					...
					<div class="card-tools">
						<a type="button" href="<?= base_url('cbtsesisiswa?kls='.$kelas_selected) ?>" class="btn btn-sm btn-default">
				...
				<div class="card-body">
                    ...
                    <?php else: ?>
                        <div class="alert alert-default-warning align-content-center" role="alert"><?=$kelas_selected == '0' ? 'Pilih kelas' : 'Belum ada data siswa'?></div>
                    <?php endif; ?>
				</div>
