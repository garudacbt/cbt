												...
												if (isset($tugas[$jamke]->id_materi)) :
													...
													<div class="card-body p-0">
														<div class="small-box bg-gradient-danger mb-0">
															...
															<a href="<?= base_url('siswa/bukatugas/'.$tugas[$jamke]->id_kjm . '/' . $jamke)?>" class="small-box-footer p-2">BUKA TUGAS
                                            ...
                                            if (isset($tugas[$jamke]->id_materi)) : ?>
                                                <tr>
                                                    ...
                                                    if (isset($mtr->id_kjm)) :
                                                        ...
                                                        <td class="align-middle" style="line-height: 1"><?=$mtr->kode_materi?>
